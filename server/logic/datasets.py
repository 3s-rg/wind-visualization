...
def get_dataset_names() -> typing.List[str]:
    """
    Returns a list of dataset names
    """

    datasets_dir = join_abs_path(__file__, "..", "..", "data", "processed")
...
def get_datasets_with_simplified_layers() -> typing.Dict[str, typing.List[str]]:
    """
    Returns a dictionary of dataset names and their simplified layer names
    """

    datasets_names = get_dataset_names()

    result = {}

    for dataset_name in datasets_names:
        dataset_dir = join_abs_path(
            __file__, "..", "..", "data", "processed", dataset_name
        )
